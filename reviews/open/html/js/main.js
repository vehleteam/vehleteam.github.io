    ...
    $(function () {
        ...
        if ( vpsSlider.length ) {
            ...
            vpsSlider.slider({
                ...
                step: 1,
                create: function () {
                    vpsActionBtn.attr('href', 'http://billing.ywhmcs.com/cart.php?systpl=OrDomain&a=add&pid=12');
                },
                ...
                slide: function( event, ui ) {
                    ...
                    switch (ui.value) {
                        case 0:
                            ...
                            vpsItemSetup = 'FREE';
                            vpsItemIp = 'UP TO 1';
                            vpsUrl = 'http://billing.ywhmcs.com/cart.php?systpl=OrDomain&a=add&pid=12';
                            break;
                        case 1.2:
                            //vpsNameTag = 'VPS 2';
                            vpsItemCPU = '2 CORES';
                            ...
                            vpsItemSetup = 'FREE';
                            vpsItemIp = 'UP TO 2';
                            vpsUrl = 'http://billing.ywhmcs.com/cart.php?systpl=OrDomain&a=add&pid=13';
                            break;
                        case 2.4:
                            //vpsNameTag = 'VPS 3';
                            vpsItemCPU = '3 CORES';
                            ...
                            vpsItemSetup = 'FREE';
                            vpsItemIp = 'UP TO 3';
                            vpsUrl = 'http://billing.ywhmcs.com/cart.php?systpl=OrDomain&a=add&pid=14';
                            break;
                        case 3.6:
                            //vpsNameTag = 'VPS 4';
                            vpsItemCPU = '4 CORES';
                            ...
                            vpsItemSetup = 'FREE';
                            vpsItemIp = 'UP TO 4';
                            vpsUrl = 'http://billing.ywhmcs.com/cart.php?systpl=OrDomain&a=add&pid=15';
                            break;
                    }
                    vpsItemCPUel.text(vpsItemCPU);
                    vpsItemRAMel.text(vpsItemRAM);
